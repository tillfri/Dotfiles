...
vim.api.nvim_set_keymap('n', 'N', 'Nzzzv', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-a>', '<C-u>zz', { noremap = true, silent = true })
...
vim.keymap.set('n', ')', '}', { noremap = true, silent = true })
vim.keymap.set('n', '<leader>xp', ':term python %<CR>:startinsert<CR>', { noremap = true, silent = true })
